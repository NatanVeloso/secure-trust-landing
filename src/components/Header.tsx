...
const Header = () => {
  ...
  return (
    <>
      {/* Header bar - separado do menu */}
      <header className="fixed top-0 left-0 right-0 z-50 border-b backdrop-blur-lg bg-background/80 dark:bg-background/90 dark:border-border/50">
      ...
      {/* Overlay - z-index acima do header */}
      <div
        className={cn(
      ...
      {/* Drawer - z-index acima do overlay */}
      <div
        className={cn(
          "fixed top-0 left-0 h-full w-3/4 max-w-xs z-[70]",
